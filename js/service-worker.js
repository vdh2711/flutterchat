...
// messagingSenderId.
firebase.initializeApp({'messagingSenderId': '915139563807'});
...
function showNotification(jsonMessage) {
	var objMessage = JSON.parse(jsonMessage);
	// The notification title
	title = objMessage.title;
	nBody = objMessage.body;
	nIcon = objMessage.icon;
	nUrl = objMessage.url;
